...
import {Container,Grid,Typography,withStyles,Button,TextField,Avatar,} from '@material-ui/core'
import { Paper, TextareaAutosize, Box, InputLabel, Select, MenuItem } from '@material-ui/core'
...
class Register extends Component {
    ...
    render() {
        ...
        const {namaJurusan,url} = this.state
        return (
                <Container fixed className={classes.wrapper}>
                    <Grid container fixed spacing={2} style={{border:'2px solid'}}>
